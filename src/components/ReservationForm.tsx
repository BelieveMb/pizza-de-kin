...
function ReservationForm() {
  return (
  <section className='bg-green-600 my-[6rem] mx-[8rem]  p-[5%] rounded-2xl '>
    <form action="" method="post">
        ...
        <div className="flex justify-center items-center mt-10">
            <button   className='rounded-xl px-12 py-3 text-gray-800 outline-none bg-yellow-400 hover:bg-red-600 hover:text-gray-50 hoduration-500 btn-font-regular' > Resérver maintenant </button>
        </div>
    </form>
  </section>
  )
